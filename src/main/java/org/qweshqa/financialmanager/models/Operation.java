...
public class Operation {
    ...
    public Operation(int id, float amount, String comment, LocalDate date, int year, int month, User user, Account involvedAccount, Category category) {
        this.id = id;
        this.amount = amount;
    ...
    public @NotNull int getMonth() {
        return month;
    }

    public void setMonth(@NotNull int month) {
        this.month = month;
    }
